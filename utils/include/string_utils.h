...
public:
    ...
    static string any2string(const T0& t0, const T1& t1, const T2& t2, const T3& t3, const T4& t4) {
        stringstream ss;
        ss << t0 << t1 << t2 << t3 << t4;
        return ss.str();
    }
    ...
    static string any2string(const T0& t0, const T1& t1, const T2& t2, const T3& t3, const T4& t4, const T5& t5) {
        stringstream ss;
